                ...
                return (
                    <div key={value.id} className="position-relative">
                        <Container className="HomePageCardContainer">
                            <Card
                                className="d-flex align-items-center justify-content-between p-3 rounded mt-4 mx-auto HomePageCard"
                                style={{ cursor: 'pointer', backgroundColor: '#2f2f2f', color: '#f3efe9', border: '3px solid #f3efe9' }}
